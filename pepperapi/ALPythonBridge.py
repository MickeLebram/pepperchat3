...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALPythonBridge", "getUsage", [name])

def eval(stringToEvaluate:str) -> str:
	"""
	eval script
	
	Parameters
	----------
	stringToEvaluate:str
		string to eval
	...
	*Reference struct*
	'''
	{
	    ...
	    "parameters": [
	        {
	            "name": "stringToEvaluate",
	            "description": "string to eval"
	        }
	    ],
	    "returnDescription": "if the evaluation has gone wrong"
	}
	'''
	"""
	return send_mfc("ALPythonBridge", "eval", [stringToEvaluate])

def evalReturn(stringToEvaluate:str) -> object:
	"""
	...
	*Reference struct*
	'''
	{
	    ...
	    "name": "evalReturn",
	    "parametersSignature": "(s)",
	    "description": "eval script and return result. evalReturn(2+2) will return 4",
	    "parameters": [
	        {
	            "name": "stringToEvaluate",
	            "description": "string to eval"
	    ...
	    "returnDescription": "the result of the evaluation"
	}
	'''
	"""
	return send_mfc("ALPythonBridge", "evalReturn", [stringToEvaluate])

def evalFull(stringToEvaluate:str) -> object:
	"""
	...
	*Reference struct*
	'''
	{
	    ...
	    "name": "evalFull",
	    "parametersSignature": "(s)",
	    "description": "evaluates script and returns an informative array.",
	    "parameters": [
	        {
	            "name": "stringToEvaluate",
	            "description": "string to eval"
	    ...
	    "returnDescription": "an array containing [return value, exceptions, stdout, stderr]"
	}
	'''
	"""
	return send_mfc("ALPythonBridge", "evalFull", [stringToEvaluate])
