...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getUsage", [name])
...
def subscribe_1(name:str, period:int, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "subscribe", [name, period, precision])
...
def subscribe_2(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "subscribe", [name])
...
def unsubscribe(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "unsubscribe", [name])
...
def updatePeriod(name:str, period:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "updatePeriod", [name, period])
...
def updatePrecision(name:str, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "updatePrecision", [name, precision])
...
def getCurrentPeriod() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getCurrentPeriod", [])
...
def getCurrentPrecision() -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getCurrentPrecision", [])
...
def getMyPeriod(name:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getMyPeriod", [name])
...
def getMyPrecision(name:str) -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getMyPrecision", [name])
...
def getSubscribersInfo() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getSubscribersInfo", [])
...
def getOutputNames() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getOutputNames", [])
...
def getEventList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getEventList", [])
...
def getMemoryKeyList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getMemoryKeyList", [])
...
def setFrameRate_1(subscriberName:str, framerate:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "setFrameRate", [subscriberName, framerate])
...
def setFrameRate_2(framerate:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "setFrameRate", [framerate])
...
def setResolution(resolution:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "setResolution", [resolution])
...
def setActiveCamera(cameraId:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "setActiveCamera", [cameraId])
...
def getFrameRate() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getFrameRate", [])
...
def getResolution() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getResolution", [])
...
def getActiveCamera() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "getActiveCamera", [])
...
def isPaused() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "isPaused", [])
...
def isProcessing() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "isProcessing", [])
...
def pause(paused:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "pause", [paused])
...
def _run() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALDarknessDetection", "_run", [])

def setDarknessThreshold(threshold:int) -> None:
	"""
	...
	----------
	threshold:int
		New darkness threshold (between 0 and 100)
	...
	*Reference struct*
	'''
	{
	    "uid": 139,
	    "returnSignature": "v",
	    "name": "setDarknessThreshold",
	    "parametersSignature": "(i)",
	    "description": "Enables to change the DarknessThreshold for isItDark",
	    "parameters": [
	        {
	            "name": "threshold",
	            "description": "New darkness threshold (between 0 and 100)"
	        }
	    ],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALDarknessDetection", "setDarknessThreshold", [threshold])

def getDarknessThreshold() -> int:
	"""
	Returns the current DarknessThreshold for isItDark
	
	Returns
	----------
	Current darkness threshold value
	...
	*Reference struct*
	'''
	{
	    "uid": 140,
	    "returnSignature": "i",
	    "name": "getDarknessThreshold",
	    "parametersSignature": "()",
	    "description": "Returns the current DarknessThreshold for isItDark",
	    "parameters": [],
	    "returnDescription": "Current darkness threshold value"
	}
	'''
	"""
	return send_mfc("ALDarknessDetection", "getDarknessThreshold", [])
