...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "enableTrace", [p0])
...
def _run() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "_run", [])
...
def _xOnMoveFailed() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "_xOnMoveFailed", [])

def _xOnFootContactChanged(p0:str, p1:object, p2:str) -> None:
	"""
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "_xOnFootContactChanged", [p0, p1, p2])
...
def _setOdometryMode(p0:bool) -> None:
	"""
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualCompass", "_setOdometryMode", [p0])
