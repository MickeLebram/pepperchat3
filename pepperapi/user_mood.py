...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "enableTrace", [p0])

def user_mood() -> object:
	"""
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("user_mood", "user_mood", [])
