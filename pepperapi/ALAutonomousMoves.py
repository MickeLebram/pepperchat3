...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "getUsage", [name])

def _moveForward() -> None:
	"""
	Move forward.
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_moveForward", [])

def _moveBackward() -> None:
	"""
	Move backward.
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_moveBackward", [])
...
def _moveSides() -> None:
	...
	*Reference struct*
	'''
	{
	    ...
	    "name": "_moveSides",
	    "parametersSignature": "()",
	    "description": "Move sides.",
	    "parameters": [],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_moveSides", [])

def _moveRandomly() -> None:
	"""
	Move randomly.
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_moveRandomly", [])

def setBackgroundStrategy(strategy:str) -> None:
	"""
	...
	----------
	strategy:str
		The autonomous background posture strategy. ("none" or "backToNeutral")
	...
	*Reference struct*
	'''
	{
	    "uid": 122,
	    "returnSignature": "v",
	    "name": "setBackgroundStrategy",
	    "parametersSignature": "(s)",
	    "description": "The background strategy.",
	    "parameters": [
	        {
	            "name": "strategy",
	            "description": "The autonomous background posture strategy. (\"none\" or \"backToNeutral\")"
	        }
	    ],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALAutonomousMoves", "setBackgroundStrategy", [strategy])

def getBackgroundStrategy() -> str:
	"""
	...
	*Reference struct*
	'''
	{
	    "uid": 123,
	    "returnSignature": "s",
	    "name": "getBackgroundStrategy",
	    "parametersSignature": "()",
	    "description": "Gets the background strategy.",
	    "parameters": [],
	    "returnDescription": "The autonomous background posture strategy. (\"none\" or \"backToNeutral\")"
	}
	'''
	"""
	return send_mfc("ALAutonomousMoves", "getBackgroundStrategy", [])

def _enableJapaneseBackgroundPosture() -> None:
	"""
	...
	*Reference struct*
	'''
	{
	    "uid": 124,
	    "returnSignature": "v",
	    "name": "_enableJapaneseBackgroundPosture",
	    "parametersSignature": "()",
	    "description": "Apply a new reset posture.",
	    "parameters": [],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_enableJapaneseBackgroundPosture", [])

def _enableDefaultBackgroundPosture() -> None:
	"""
	Apply a new reset posture.
	...
	*Reference struct*
	'''
	{
	    "uid": 125,
	    "returnSignature": "v",
	    "name": "_enableDefaultBackgroundPosture",
	    "parametersSignature": "()",
	    "description": "Apply a new reset posture.",
	    "parameters": [],
	    "returnDescription": ""
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_enableDefaultBackgroundPosture", [])

def _disableBackgroundPosture() -> None:
	"""
	Apply a new reset posture.
	...
	*Reference struct*
	'''
	{
	    "uid": 126,
	    "returnSignature": "v",
	    "name": "_disableBackgroundPosture",
	    "parametersSignature": "()",
	    "description": "Apply a new reset posture.",
	    "parameters": [],
	    "returnDescription": ""
	...
	'''
	"""
	return send_mfc("ALAutonomousMoves", "_disableBackgroundPosture", [])
