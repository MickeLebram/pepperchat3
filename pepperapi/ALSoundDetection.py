...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getUsage", [name])
...
def subscribe_1(name:str, period:int, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "subscribe", [name, period, precision])
...
def subscribe_2(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "subscribe", [name])
...
def unsubscribe(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "unsubscribe", [name])
...
def updatePeriod(name:str, period:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "updatePeriod", [name, period])
...
def updatePrecision(name:str, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "updatePrecision", [name, precision])
...
def getCurrentPeriod() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getCurrentPeriod", [])
...
def getCurrentPrecision() -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getCurrentPrecision", [])
...
def getMyPeriod(name:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getMyPeriod", [name])
...
def getMyPrecision(name:str) -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getMyPrecision", [name])
...
def getSubscribersInfo() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getSubscribersInfo", [])
...
def getOutputNames() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getOutputNames", [])
...
def getEventList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getEventList", [])
...
def getMemoryKeyList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "getMemoryKeyList", [])
...
def isPaused() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "isPaused", [])
...
def pause(status:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "pause", [status])
...
def isProcessing() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "isProcessing", [])
...
def setParameter(parameter:str, value:object) -> None:
	...
	----------
	parameter:str
		Name of the parameter. "Sensibility" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. "EnergyComputation" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the "ALSoundDetection/SoundLocated" ALMemory key.
	value:object
	...
	*Reference struct*
	'''
	{
	    ...
	    "parameters": [
	        {
	            "name": "parameter",
	            "description": "Name of the parameter. \"Sensibility\" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. \"EnergyComputation\" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the \"ALSoundDetection/SoundLocated\" ALMemory key."
	        },
	        {
	            "name": "value",
	...
	'''
	"""
	return send_mfc("ALSoundDetection", "setParameter", [parameter, value])
