...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "enableTrace", [p0])
...
def _start() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "_start", [])
...
def _stop() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "_stop", [])
...
def _isStarted() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "_isStarted", [])
...
def _list() -> List[object]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "_list", [])

def _listReactor() -> Dict[int,str]:
	"""
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "_listReactor", [])
...
def _purgeAll() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALExpressionWatcher", "_purgeAll", [])
