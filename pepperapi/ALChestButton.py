...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "getUsage", [name])

def _setEnableNotifications(enable:bool) -> None:
	"""
	...
	*Reference struct*
	'''
	{
	    "uid": 114,
	    "returnSignature": "v",
	    "name": "_setEnableNotifications",
	    "parametersSignature": "(b)",
	    "description": "Enables / Disables notifications.",
	    "parameters": [
	        {
	            "name": "enable",
	...
	'''
	"""
	return send_mfc("ALChestButton", "_setEnableNotifications", [enable])

def _areNotificationsEnabled() -> bool:
	"""
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALChestButton", "_areNotificationsEnabled", [])
