...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getUsage", [name])
...
def subscribe_1(name:str, period:int, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "subscribe", [name, period, precision])
...
def subscribe_2(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "subscribe", [name])
...
def unsubscribe(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "unsubscribe", [name])
...
def updatePeriod(name:str, period:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "updatePeriod", [name, period])
...
def updatePrecision(name:str, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "updatePrecision", [name, precision])
...
def getCurrentPeriod() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getCurrentPeriod", [])
...
def getCurrentPrecision() -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getCurrentPrecision", [])
...
def getMyPeriod(name:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getMyPeriod", [name])
...
def getMyPrecision(name:str) -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getMyPrecision", [name])
...
def getSubscribersInfo() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getSubscribersInfo", [])
...
def getOutputNames() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getOutputNames", [])
...
def getEventList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getEventList", [])
...
def getMemoryKeyList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getMemoryKeyList", [])
...
def isPaused() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "isPaused", [])
...
def pause(status:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "pause", [status])
...
def isProcessing() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "isProcessing", [])

def analyzeFaceCharacteristics(id:int) -> bool:
	"""
	...
	Returns
	----------
	True if the face analysis succeeded, false otherwise.
	...
	*Reference struct*
	'''
	{
	    "uid": 130,
	    "returnSignature": "b",
	    "name": "analyzeFaceCharacteristics",
	    "parametersSignature": "(i)",
	    "description": "Runs face analysis for a given person ID.",
	    "parameters": [
	        {
	            "name": "id",
	    ...
	    "returnDescription": "True if the face analysis succeeded, false otherwise."
	}
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "analyzeFaceCharacteristics", [id])

def setSmilingThreshold(threshold:float) -> None:
	"""
	...
	----------
	threshold:float
		New threshold (must be between 0.0 and 1.0.
	...
	*Reference struct*
	'''
	{
	    "uid": 131,
	    "returnSignature": "v",
	    "name": "setSmilingThreshold",
	    "parametersSignature": "(f)",
	    "description": "Sets the smile degree threshold above which an event is raised.",
	    "parameters": [
	        {
	            "name": "threshold",
	            "description": "New threshold (must be between 0.0 and 1.0."
	        }
	    ],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "setSmilingThreshold", [threshold])

def getSmilingThreshold() -> float:
	"""
	Gets the smile degree threshold above which an event is raised.
	
	Returns
	----------
	Threshold for Smiling event
	...
	*Reference struct*
	'''
	{
	    "uid": 132,
	    "returnSignature": "f",
	    "name": "getSmilingThreshold",
	    "parametersSignature": "()",
	    "description": "Gets the smile degree threshold above which an event is raised.",
	    "parameters": [],
	    "returnDescription": "Threshold for Smiling event"
	}
	'''
	"""
	return send_mfc("ALFaceCharacteristics", "getSmilingThreshold", [])
