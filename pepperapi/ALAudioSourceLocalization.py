...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getUsage", [name])
...
def subscribe_1(name:str, period:int, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "subscribe", [name, period, precision])
...
def subscribe_2(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "subscribe", [name])
...
def unsubscribe(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "unsubscribe", [name])
...
def updatePeriod(name:str, period:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "updatePeriod", [name, period])
...
def updatePrecision(name:str, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "updatePrecision", [name, precision])
...
def getCurrentPeriod() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getCurrentPeriod", [])
...
def getCurrentPrecision() -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getCurrentPrecision", [])
...
def getMyPeriod(name:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getMyPeriod", [name])
...
def getMyPrecision(name:str) -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getMyPrecision", [name])
...
def getSubscribersInfo() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getSubscribersInfo", [])
...
def getOutputNames() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getOutputNames", [])
...
def getEventList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getEventList", [])
...
def getMemoryKeyList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "getMemoryKeyList", [])
...
def isPaused() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "isPaused", [])
...
def pause(status:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "pause", [status])
...
def isProcessing() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "isProcessing", [])
...
def setParameter(parameter:str, value:object) -> None:
	...
	----------
	parameter:str
		Name of the parameter. "Sensibility" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. "EnergyComputation" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the "ALSoundLocalization/SoundLocated" ALMemory key.
	value:object
		"Sensibility" : a float in [0,1]. "EnergyComputation" : (1 or 0).
	...
	*Reference struct*
	'''
	{
	    ...
	    "parameters": [
	        {
	            "name": "parameter",
	            "description": "Name of the parameter. \"Sensibility\" between 0 and 1 to adjust the capacity of NAO to locate quiet sounds. \"EnergyComputation\" (1 or 0) that activates the computation of the located source signal energy. This energy is added in the \"ALSoundLocalization/SoundLocated\" ALMemory key."
	        },
	        {
	            "name": "value",
	            "description": "\"Sensibility\" : a float in [0,1]. \"EnergyComputation\" : (1 or 0)."
	        }
	    ],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALAudioSourceLocalization", "setParameter", [parameter, value])
