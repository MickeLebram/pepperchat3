...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getUsage", [name])
...
def subscribe_1(name:str, period:int, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "subscribe", [name, period, precision])
...
def subscribe_2(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "subscribe", [name])
...
def unsubscribe(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "unsubscribe", [name])
...
def updatePeriod(name:str, period:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "updatePeriod", [name, period])
...
def updatePrecision(name:str, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "updatePrecision", [name, precision])
...
def getCurrentPeriod() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getCurrentPeriod", [])
...
def getCurrentPrecision() -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getCurrentPrecision", [])
...
def getMyPeriod(name:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getMyPeriod", [name])
...
def getMyPrecision(name:str) -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getMyPrecision", [name])
...
def getSubscribersInfo() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getSubscribersInfo", [])
...
def getOutputNames() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getOutputNames", [])
...
def getEventList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getEventList", [])
...
def getMemoryKeyList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getMemoryKeyList", [])

def setGridPrecision(precision:float) -> None:
	"""
	Sets grid precision
	...
	----------
	precision:float
		float, ratio between camera field of view and grid cell field of view in each dimension. Setting the grid precision will reset the grid.
	...
	*Reference struct*
	'''
	{
	    "uid": 127,
	    "returnSignature": "v",
	    "name": "setGridPrecision",
	    "parametersSignature": "(f)",
	    "description": "Sets grid precision",
	    "parameters": [
	        {
	            "name": "precision",
	            "description": "float, ratio between camera field of view and grid cell field of view in each dimension. Setting the grid precision will reset the grid."
	        }
	    ],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "setGridPrecision", [precision])

def getGridPrecision() -> float:
	"""
	Gets grid precision
	...
	*Reference struct*
	'''
	{
	    "uid": 128,
	    "returnSignature": "f",
	    "name": "getGridPrecision",
	    "parametersSignature": "()",
	    "description": "Gets grid precision",
	    "parameters": [],
	    "returnDescription": "Grid precision"
	}
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "getGridPrecision", [])
...
def resetGrid() -> None:
	...
	*Reference struct*
	'''
	{
	    ...
	    "name": "resetGrid",
	    "parametersSignature": "()",
	    "description": "Resets grid with current timestamp",
	    "parameters": [],
	    "returnDescription": ""
	}
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "resetGrid", [])
...
def _run() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALVisualSpaceHistory", "_run", [])
