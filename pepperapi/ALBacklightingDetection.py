...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getUsage", [name])
...
def subscribe_1(name:str, period:int, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "subscribe", [name, period, precision])
...
def subscribe_2(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "subscribe", [name])
...
def unsubscribe(name:str) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "unsubscribe", [name])
...
def updatePeriod(name:str, period:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "updatePeriod", [name, period])
...
def updatePrecision(name:str, precision:float) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "updatePrecision", [name, precision])
...
def getCurrentPeriod() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getCurrentPeriod", [])
...
def getCurrentPrecision() -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getCurrentPrecision", [])
...
def getMyPeriod(name:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getMyPeriod", [name])
...
def getMyPrecision(name:str) -> float:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getMyPrecision", [name])
...
def getSubscribersInfo() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getSubscribersInfo", [])
...
def getOutputNames() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getOutputNames", [])
...
def getEventList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getEventList", [])
...
def getMemoryKeyList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getMemoryKeyList", [])
...
def setFrameRate_1(subscriberName:str, framerate:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "setFrameRate", [subscriberName, framerate])
...
def setFrameRate_2(framerate:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "setFrameRate", [framerate])
...
def setResolution(resolution:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "setResolution", [resolution])
...
def setActiveCamera(cameraId:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "setActiveCamera", [cameraId])
...
def getFrameRate() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getFrameRate", [])
...
def getResolution() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getResolution", [])
...
def getActiveCamera() -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "getActiveCamera", [])
...
def isPaused() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "isPaused", [])
...
def isProcessing() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "isProcessing", [])
...
def pause(paused:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "pause", [paused])
...
def _run() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALBacklightingDetection", "_run", [])
