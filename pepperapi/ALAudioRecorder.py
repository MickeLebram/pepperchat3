...
def registerEvent(p0:int, p1:int, p2:int) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "registerEvent", [p0, p1, p2])
...
def unregisterEvent(p0:int, p1:int, p2:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "unregisterEvent", [p0, p1, p2])
...
def metaObject(p0:int) -> MetaObject:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "metaObject", [p0])
...
def terminate(p0:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "terminate", [p0])
...
def property(p0:object) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "property", [p0])
...
def setProperty(p0:object, p1:object) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "setProperty", [p0, p1])
...
def properties() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "properties", [])
...
def registerEventWithSignature(p0:int, p1:int, p2:int, p3:str) -> int:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "registerEventWithSignature", [p0, p1, p2, p3])
...
def isStatsEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "isStatsEnabled", [])
...
def enableStats(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "enableStats", [p0])
...
def stats() -> Dict[int,MethodStatistics]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "stats", [])
...
def clearStats() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "clearStats", [])
...
def isTraceEnabled() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "isTraceEnabled", [])
...
def enableTrace(p0:bool) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "enableTrace", [p0])
...
def version() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "version", [])
...
def ping() -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "ping", [])
...
def getMethodList() -> List[str]:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "getMethodList", [])
...
def getMethodHelp(methodName:str) -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "getMethodHelp", [methodName])
...
def getModuleHelp() -> object:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "getModuleHelp", [])
...
def wait_1(id:int, timeoutPeriod:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "wait", [id, timeoutPeriod])
...
def wait_2(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "wait", [id])
...
def isRunning(id:int) -> bool:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "isRunning", [id])
...
def stop(id:int) -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "stop", [id])
...
def getBrokerName() -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "getBrokerName", [])
...
def getUsage(name:str) -> str:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "getUsage", [name])

def startMicrophonesRecording(filename:str, type:str, samplerate:int, channels:object) -> None:
	"""
	...
	*Reference struct*
	'''
	{
	    ...
	    "parametersSignature": "(ssim)",
	    "description": "This method allows to record the signal collected on the nao's microphones. You can choose to record only the front microphone in a ogg file, or the 4 microphones in a wav file.",
	    "parameters": [
	        {
	            "name": "filename",
	        ...
	        {
	            "name": "type",
	            "description": "wav or ogg."
	        },
	        {
	            "name": "samplerate",
	            "description": "Required sample rate."
	        },
	        {
	            "name": "channels",
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "startMicrophonesRecording", [filename, type, samplerate, channels])
...
def stopMicrophonesRecording() -> None:
	...
	*Reference struct*
	...
	'''
	"""
	return send_mfc("ALAudioRecorder", "stopMicrophonesRecording", [])

def _isRecordingThisFile(fileName:str) -> bool:
	"""
	...
	Returns
	----------
	1 if the file is currently beeing recording / 0 otherwise
	...
	*Reference struct*
	'''
	{
	    "uid": 116,
	    "returnSignature": "b",
	    "name": "_isRecordingThisFile",
	    "parametersSignature": "(s)",
	    "description": "This function allows you to know if ALAudioDevice is currently recording the file you give in argument",
	    "parameters": [
	        {
	            "name": "fileName",
	    ...
	    "returnDescription": "1 if the file is currently beeing recording / 0 otherwise"
	}
	'''
	"""
	return send_mfc("ALAudioRecorder", "_isRecordingThisFile", [fileName])
